          ...
          body: Form(
            ...
            child: Column(
              children: [
                ...
                Container(padding: const EdgeInsets.only(top: 20, left: 15, right: 20), child: Align(alignment: Alignment.center, child: TextFormField(validator: validatePassword, controller:passwordController, obscureText: true, decoration: const InputDecoration(icon: Icon(Icons.password), hintText: "Password", hintMaxLines: 10),) ,)),
