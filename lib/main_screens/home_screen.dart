                        ...
                        if (document['awaitConfirmation'] == 2 && DateFormat('dd-MM-yyyy').format(DateTime.now()).toString() == document['date']) {
                          return TapToExpand(
                            ...
                            content: Column(
                              ...
                              children: [
                                Text("Vagt: ${document['details']}", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w500)),
                                Padding(padding: EdgeInsets.only(top: 7)),
                                Text("Status: ${document['status']}", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w500)),
                                Padding(padding: EdgeInsets.only(top: 7)),
                                Text("Kommentar: ${document['details']}", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w500)),
                          ...
                          return TapToExpand(
                            ...
                            content: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("Vagt: ${document['details'].substring(0,11)}", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w500)),
                                Padding(padding: EdgeInsets.only(top: 7)),
                                Text("Status: ${document['status']}", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w500)),
                                Padding(padding: EdgeInsets.only(top: 7)),
                                Text("Kommentar: ${document['details'].substring(23)}", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w500)),
                          ...
                          return TapToExpand(
                            ...
                            content: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("Tilgængelighed: ${document['time']}", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w500)),
                                Padding(padding: EdgeInsets.only(top: 7)),
                                Text("Kommentar: ${document['comment']}", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w500)),
                                Padding(padding: EdgeInsets.only(top: 30)),
                                Center(child: ElevatedButton(onPressed: (){
                                  var reference = document as QueryDocumentSnapshot<Map<String, dynamic>>;
                                  Navigator.push(context, MaterialPageRoute(builder: (context) => OwnDaysDetailsScreen(
